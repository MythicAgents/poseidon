...
- Added build support for Linux MIPS/MIPSLE/MIPS64/MIPS64LE, Static executable builds only
- CGO disabled when building for mips
- Configurable soft-float/hard-float ABI when compiling for mips
